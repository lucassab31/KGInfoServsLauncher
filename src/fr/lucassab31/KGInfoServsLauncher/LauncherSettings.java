...
public class LauncherSettings extends IScreen {
	 ...
	 this.drawBackgroundImage(engine, root, "settings_bg.png");
	 ...
	 public void handle(ActionEvent event) {
			 pane.userConfig.writeConfig("" + memorySlider.getValue(), windowsSizeList.getValue(), "false");
